 ...
 * and directories rename/move too (`kind: 'dir'` in the response). For files the extension
 * KIND stays unchanged (md↔md, base↔base — `.md` ↔ `.markdown` is one kind); extension
 * rules do not apply to directories.
 *
